...
class Authentication{
    client = new Client().setEndpoint('https://cloud.appwrite.io/v1').setProject(process.env.APPWRITE_PROJECTID).setKey(process.env.APPWRITE_APIKEY);
    constructor() {
    ...
    delete =async (req,res)=>{
        this.users.delete(req.params.userid).then((e)=>{
